<?php
add_action( 'vc_before_init', 'arqam_promo_box_integrateWithVC' );
function arqam_promo_box_integrateWithVC() {

vc_map( 
    array(
    "name" => esc_html__( "Arqam Promo box", "arqam-toolkit" ),
    "base" => "arqam_promo_box",
